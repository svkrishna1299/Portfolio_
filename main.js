...
const PROJECTS = {
  ...
  'foiling-craft': {
    ...
    images: [
      ...
      { file: 'mesh.png',    caption: 'Computational mesh — NACA 0012 overset region (background + overset) with 15 prism layers and wake refinement (89,036 cells)' },
      { file: 'domain.png',  caption: 'Computational domain — 6×6 m with velocity inlet, pressure outlet, and slip-wall boundaries; overset foil region at domain centre' },
